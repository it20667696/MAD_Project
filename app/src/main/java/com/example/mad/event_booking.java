...
public class event_booking extends AppCompatActivity {
    ...
    String[] Type = {"Conference","Birthday", "Wedding"};

    String[] No_of_event = {"01", "02", "03"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlogout.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent logout =new Intent( event_booking.this,Login.class );
        ...
        //Creating the ArrayAdapter instance having the country list
        ArrayAdapter aa1 = new ArrayAdapter(this, android.R.layout.simple_spinner_item, No_of_event);
        aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        //Setting the ArrayAdapter data on the Spinner
    ...
    AdapterView.OnItemSelectedListener onItemSelectedListener2 =
            new AdapterView.OnItemSelectedListener() {
                ...
                @Override
                public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long id) {
                    String s2 = String.valueOf(No_of_event[position]);
                    no_room.setText(s2);
                }
    ...
    public void DeleteDetail() {
        btnDelete.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Integer deletedRows = mydB1.deleteDetail(phone.getText().toString());
                        if (deletedRows > 0) {
                            Toast.makeText( event_booking.this, "Booking Cancelled", Toast.LENGTH_LONG ).show();
                            clearControls();
                        }else
                            Toast.makeText(event_booking.this, "Booking Not Cancelled", Toast.LENGTH_LONG).show();
    ...
    public void UpdateDetail() {
        btnUpdate.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        boolean isUpdate = mydB1.updateDetail(type.getText().toString(), name.getText().toString(), phone.getText().toString(),
                                mail.getText().toString(), tvDisplayDate.getText().toString(), tvDisplayDate2.getText().toString(),
                                no_room.getText().toString(), totcost.getText().toString());
                        if (isUpdate == true && awesomeValidation.validate()) {
                            Toast.makeText( event_booking.this, "Booking Details Updated", Toast.LENGTH_LONG ).show();
                            clearControls();
                        }else
                            Toast.makeText(event_booking.this, "Booking Details Not Updated", Toast.LENGTH_LONG).show();
        ...
        cButton.setOnClickListener(
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        boolean isInserted = mydB1.insertData(type.getText().toString(), name.getText().toString(), phone.getText().toString(),
                                mail.getText().toString(), tvDisplayDate.getText().toString(), tvDisplayDate2.getText().toString(),
                                Integer.parseInt(no_room.getText().toString()), Integer.parseInt(totcost.getText().toString()));
                        if (isInserted == true && awesomeValidation.validate())
                            Toast.makeText( event_booking.this, "Booking Confirmed", Toast.LENGTH_LONG ).show();

                        else
                            Toast.makeText(event_booking.this, "Booking Not Confirmed", Toast.LENGTH_LONG).show();
                    }
                }
        );
        btnlogout.setOnClickListener(new View.OnClickListener() {
    ...
    public int calculate() {
        ...
        if(type.getText().toString().equalsIgnoreCase("Conference")){
        ...
        else if(type.getText().toString().equalsIgnoreCase("Birthday")){
            int cal = rcost2 * rnum;
            return cal;
        }
        else{
