...
public class PatientAdapterClass extends RecyclerView.Adapter<PatientAdapterClass.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.textViewID.setText(Integer.toString(patientModelClass.getId()));
        holder.editText_Name.setText(patientModelClass.getName());
        ...
        holder.button_Edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseHelperClass.updateEmployee(new PatientModelClass(patientModelClass.getId(),stringName,stringEmail));
        ...
        holder.button_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databaseHelperClass.deleteEmployee(patientModelClass.getId());
